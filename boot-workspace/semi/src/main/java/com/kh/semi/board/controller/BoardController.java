...
public class BoardController {
	...
	public ResponseEntity<Void> save(@Valid BoardDto board,
		...
		// 게시글 제목, 내용, 작성자, 첨부파일 정보
		// log.info("게시글 정보 : {} / 파일 정보 : {} / 사용자 아이디 : {}", board, file.getOriginalFilename(), user.getUsername());
	...
	public ResponseEntity<Void> deleteByBoardNo() {
		
		boardService.deleteByBordNo(user, boardNo);
